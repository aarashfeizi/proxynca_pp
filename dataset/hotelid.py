...
class HotelsID_hdf5(BaseDataset_hdf5):
    def __init__(self, root, source, classes, transform=None):
...
class HotelsID_hdf5_alt(BaseDataset_hdf5_alt):
    def __init__(self, root, source, classes, transform=None):
...
class HotelsID_hdf5_bb(BaseDataset_hdf5_bb):
    def __init__(self, root, source, classes, transform=None):
...
class HotelsID_class(BaseDatasetMod):
